...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{| p{37mm} p{6mm} p{20mm} X |}
		...
		\textbf{dist\_key [5:0]}             & \ttfamily{32b} & \ttfamily{0x00000000} & distiller [5:0] off by default (mask = 0)  \\%
		\textbf{dist\_mask [5:0]}            & \ttfamily{32b} & \ttfamily{0x00000000} & distiller [5:0] off by default (mask = 0) \\%
		\textbf{dist\_shift [5:0]}           & \ttfamily{32b} & \ttfamily{0x00000000} & distiller [5:0] off by default (mask = 0) \\%
		\hline
	\end{tabularx}
