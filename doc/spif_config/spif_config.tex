...
% --------------------------------------------------------------------------
\def\myversion{Version 0.0.2}
\def\mydate{03 September 2021}
...
%		\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\textwidth}{| p{36mm} p{13mm} p{21mm} p{7mm} X |}
		...
		\textbf{mp1\_key}                    & 82                         & (0x51)                         & r/w                 & mapper1 - used if event pipes$>$1 \\%
...
\begin{center}
	\rowcolors {1}{}{ \tblc }
	%		\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\textwidth}{| p{36mm} p{11mm} p{21mm} X |}
		\hline
