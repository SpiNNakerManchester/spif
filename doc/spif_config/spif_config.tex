...
%		\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\textwidth}{| p{34mm} p{13mm} p{21mm} p{7mm} X |}
		...
		\textbf{input\_drop\_wait}           & 03                         & (0x03)                         & w                   & periph in wait-before-drop value \\%
		\textbf{output\_drop\_wait}          & 04                         & (0x04)                         & w                   & periph out wait-before-drop value \\%
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{| p{35mm} p{11mm} p{22mm} X |}
		...
		\textbf{input\_drop\_wait}           & \ttfamily{32b} & \ttfamily{32}         & 512 for 0 drops in worst-case traffic \\%
		\textbf{output\_drop\_wait}          & \ttfamily{32b} & \ttfamily{32}         & \\%
