...
%		\renewcommand{\arraystretch}{1.2}
	\begin{tabularx}{\textwidth}{| p{34mm} p{13mm} p{21mm} p{7mm} X |}
		...
		\textbf{mp\_key}                     & 01                         & (0x01)                         & r/w                 & routing key for event mapping \\%
		...
		\textbf{mp\_fld\_mask [3:0]}         & 80-83                      & (0x50-0x53)                    & r/w                 & field masks for event mapping \\%
		\cellcolor{gray!25}\textbf{reserved} & \cellcolor{gray!25}84-95   & \cellcolor{gray!25}(0x54-0x5f) & \cellcolor{gray!25} & \cellcolor{gray!25}\\%
		\textbf{mp\_fld\_shift [3:0]}        & 96-99                      & (0x60-0x63)                    & r/w                 & field shifts for event mapping  \\%
